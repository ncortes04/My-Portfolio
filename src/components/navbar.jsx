...
function NavBar() {
  ...
  return (
    <nav
      className={scroll < 100 ? "navbar-container" : "navbar-container active"}
      style={
        useLocation().pathname !== "/"
          ? { position: "static", background: "black" }
          : null
      }
    >
      <a className="h1-link" href="/My-Portfolio">
        <h1 className="nav-header">Nicholas Cortes</h1>
      </a>
